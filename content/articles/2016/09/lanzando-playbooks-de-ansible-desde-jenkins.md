...
Somos muchos los amantes del terminal para ejecutar nuestras tareas, sea con **Ansible** o con otras herramientas. A veces nos puede convenir dotar la herramienta de un entorno gráfico o web para que lo hagan otras personas. Aunque ya existe como producto **Ansible Tower**, su precio es prohibitivo para muchos.<!--more-->
