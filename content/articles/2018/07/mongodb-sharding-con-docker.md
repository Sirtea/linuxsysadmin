...
El otro día estaba revisando viejos artículos, y me tropecé con [uno anterior]({{< relref "/articles/2016/05/mongodb-sharding-con-ansible.md" >}}). Este estaba montado con **ansible**, y se me pasó por la cabeza reescribirlo usando contenedores con **docker**. Así pues, vamos a montar exactamente el mismo *cluster*, pero con el cambio que la última revolución tecnológica nos aporta.<!--more-->
